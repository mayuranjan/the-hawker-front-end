import { Directive, ElementRef, Output, HostListener, Renderer, AfterViewInit, Input } from '@angular/core';
...
export class ActiveDirective implements AfterViewInit {
	...
	ngAfterViewInit() {
		this.initComponent();
		if(this.mdbActive === "" || (this.mdbActive != undefined && this.mdbActive == true)) {
			this.checkValue();
		}
	}
